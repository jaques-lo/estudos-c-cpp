...
| **Pop!_OS** | Sistema operacional (notebook) |
| **Zorin OS** | Sistema operacional (PC) |
...
Olá! Me chamo **Lorenzo Jaques** e sou estudante de **Técnico em Informática** na **Escola Técnica Estadual Portão (ETEP)**, com conclusão prevista para **2026**.

Tenho interesse em **suporte técnico, infraestrutura, Linux, redes e programação**.

Mantenho um **homelab** para estudos e prática, onde trabalho com virtualização usando **Proxmox**, configuração de serviços Linux, redes, acesso remoto e troubleshooting.

Conhecimentos:
- Linux (**Debian, Ubuntu, Fedora, Linux Mint, Pop!_OS e Zorin OS**)
